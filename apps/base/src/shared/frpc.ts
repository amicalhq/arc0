 ...
 * Proxy name includes workstationId + subdomain to avoid conflicts on frps.
 */
export function generateFrpcConfig(subdomain: string, workstationId: string): string {
  const proxyName = `${workstationId}-${subdomain}`;
